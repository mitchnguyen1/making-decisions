...
if(amysAge > brittanisAge){
  ...
  console.log("The age is the same")
}
...
/*
  ...
  If they were, console.log 'Amy & Brittani were born in the same year'. If they were not, console.log 'Amy & Brittani were 
...
/*
  ...
  between 60 and 80 degrees, and raining, one should wear a rain-jacket. If it is 60 degrees or below, one should wear a 
...
if(temperature >= 80 && rain){
  console.log("Where a tshit and take an umbrella")
}
else if(temperature > 60 && temperature < 80 && rain){
  console.log("Where a rain-jacket")
}
else if(temperature <= 60 && rain){
  console.log("Where a jacket and carry an umbrella")
}
else if(temperature >= 80 && !rain){
  console.log("Where a tshit")
}
else if(temperature > 60 && temperature < 80 && !rain){
  console.log("Where a jacket")
}
else if(temperature <= 60 && !rain){
  console.log("Where a thick-jacket and layer up ")
}
////////// PROBLEM 5 //////////
